...
class Settings(BaseSettings):
    ...
    # 配置你的Mysql环境
    MYSQL_USERNAME: str = config("USERNAME", default="fastapi")
    MYSQL_PASSWORD: str = config("PASSWORD",default="")
    ...
    print("!111",MYSQL_USERNAME)
    print("!222",MYSQL_PASSWORD)
    print("!333",MYSQL_PORT)
    print("!444",MYSQL_DATABASE)
